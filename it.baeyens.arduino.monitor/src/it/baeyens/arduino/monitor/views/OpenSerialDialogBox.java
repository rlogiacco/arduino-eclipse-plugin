...
public class OpenSerialDialogBox extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		this.baudRates.getCombo()
				.setText(InstancePreferences.getGlobalString(Const.KEY_SERIAL_RATE, Const.EMPTY_STRING));
		this.serialPorts.getCombo()
				.setText(InstancePreferences.getGlobalString(Const.KEY_SERIAL_PORT, Const.EMPTY_STRING));
