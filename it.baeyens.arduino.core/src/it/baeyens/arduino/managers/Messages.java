...
public class Messages extends NLS {
	...
	public static String Manager_Downloading_make_exe;
	...
	public static String Manager_unable_to_create_file;
	public static String Manager_unable_to_write_to_file;
	public static String Manager_Warning_file;
	public static String Manager_will_not_work;
