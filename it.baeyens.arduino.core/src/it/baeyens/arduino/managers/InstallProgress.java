...
public class InstallProgress {
	...
	protected static String getMessage() {
		...
		message.append("Thank you for downloading Sloeber!"); //$NON-NLS-1$
		message.append("We need to install a few things to get you "); //$NON-NLS-1$
		message.append("up and running. Depending on your internet speed "); //$NON-NLS-1$
		message.append("it can take anywhere between two minutes and half an hour.").append("\n\n"); //$NON-NLS-1$ //$NON-NLS-2$
